...
if(isset($POST["submit"])) {
    ...
    if(!mysqli_stmt_prepare($stmt, $sql)) {
        ...
        mysqli_stmt_bind_param($stmt, "ssssssssssssssss", $student_number, $first_name, $last_name, $birthday, $contact_number, $troupe, $course, $curriculum_year, $date_of_membership, $active_status, );
