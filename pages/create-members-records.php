                ...
                <div class="card-body">
                    <form action="../includes/controller/create-members-permanent-records.php" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                    <select name="active_status" id="active_status" class="form-control" style="color: black" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="mothers_name" id="mothers_name"  class="form-control" style="color: black" placeholder="Enter mothers name"   />
                            </div>
                        </div>
