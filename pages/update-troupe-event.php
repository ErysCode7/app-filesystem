...
<section>
  <div class="container py-5">
        ...
        <div class="col">
            ...
            <ol class="breadcrumb mb-0">
                <?php 
                    ...
                    $sql = "SELECT * FROM troupes WHERE id = '$troup_id';";
                    $result = $con->query($sql);
                    $row = $result->fetch_assoc();
                ?>
                <li class="breadcrumb-item"><a href="./view-troupe-event.php?id=<?=$troup_id?>"><?=$row["name"]?></a></li>
    ...
    <div class="col-xxl">
            ...
            <div class="card-body">
                <form action="../includes/controller/update-troupe-event.php" method="post">
                    <input type="hidden" name="id" value="<?= $id ?>">  
                    <input type="hidden" name="troup_id" value="<?= $troup_id ?>">    
                    <div class="row mb-3">
